...
<div class="cztable">
	<form action="/power/user/updateUsertb" method="post">
<table border="1" width="100%" class="table_a">
    <input type="hidden" name="userId" value="${usertb.userId}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="userSex" ${usertb.userSex=="男"?"checked":""} value="男" />男
                        <input type="radio" name="userSex" ${usertb.userSex=="女"?"checked":""} value="女"/>女
                    </td>
                </tr>
				...
				<tr>
                    <td>联系电话：</td>
                    <td>
                        <input type="text" name="userPhone" value="${usertb.userPhone}" />
                    </td>                
                </tr>
