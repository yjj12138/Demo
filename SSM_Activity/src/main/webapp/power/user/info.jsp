...
<table border="1" width="100%" class="table_a">
                ...
                <tr>
                    ...
                    <td>
                        <input type="radio" name="gender" ${userTb.userSex=='男'?"checked":""} value="男" />男 <input type="radio" name="gender" ${userTb.userSex=='男'?"":"checked"} value="女"/>女
                    </td>
                </tr>
				...
				<tr>
                    ...
                    <td>
                        <select name="roleId">
							<option>${userTb.role.rolename}</option>
						</select>
                    </td>
                </tr>
