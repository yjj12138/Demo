...
<div class="morebt">
 ...
 <div class="cztable">
     <div>
         <a href="/qingjia/add.jsp">添加请假单</a>
     </div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr style="height: 25px" align="center">
                ...
                <th scope="col">${usertb.userRealname}</th>
                <th scope="col">${lb.days}</th>
                <th scope="col">${lb.content}</th>
                <th scope="col">${lb.remark}</th>
                <th scope="col"><fmt:formatDate value="${lb.date}" pattern="yyyy/MM/dd"></fmt:formatDate></th>
                <th scope="col">
                    ${lb.state==0?"初始录入":lb.state==1?"开始审批":lb.state==2?"审批完成":"审批不通过"}
                </th>
                <th scope="col">
                    <c:if test="${lb.state==0}">
                        <a href="/qingjia/commit?id=${lb.id}">提交</a>
                    </c:if>
