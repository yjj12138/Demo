...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $("#tAll").click(function () {
               location.href="/book/ziliaolist"
            });
            $("#1").click(function () {
                location.href="/book/mohuziliaolist?tid=1";
            });
            $("#2").click(function () {
                location.href="/book/mohuziliaolist?tid=2";
            });
            $("#3").click(function () {
                location.href="/book/mohuziliaolist?tid=3";
            });
            $("#4").click(function () {
                location.href="/book/mohuziliaolist?tid=4";
            });
        })
    </script>
</head>
<body>
	...
	<div class="div_head" style="width: 100%;text-align:center;">
            <span>
                ...
                <span style="float:right;margin-right: 8px;font-weight: bold">
                	<a style="text-decoration: none" href="/book/getfiletype">【上传】</a> &emsp;
    ...
    <div class="fllist">
        <form action="/book/ziliaolist" method="post">
        <ul>
           	<li>
            <strong>
            标题:&nbsp;&nbsp;
        ...
        <div class="cztable">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                ...
                <td>
                    ...
                    <td>
                        <a href="/book/xiangqing?informationid=${bk.informationid}">详情</a>
                        <a href="/book/edit?informationid=${bk.informationid}">编辑</a>
                    </td>
                </tr>
                </c:forEach>
            </table>
            <div class='MainStyle'>
                <div class=''>
                    <pagetag:seperator url="/book/ziliaolist?title=${t}" pageInfo="${pageInfo}"></pagetag:seperator>
                </div>
            </div>
