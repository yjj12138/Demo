...
public class MenuExcelPoi {
    ...
    //设置第二行及以后的数据
    public static void createOthers(List<Menu> list) {
        for (int i = 0; i < list.size(); i++) {
            ...
            cell2.setCellValue(menu.getMenuname());
            //第三列
            HSSFCell cell3 = row.createCell(2);
            cell3.setCellValue(menu.getMenupath());
            //第四列
            HSSFCell cell4 = row.createCell(3);
            cell4.setCellValue(menu.getMenustate());
        }
    }
