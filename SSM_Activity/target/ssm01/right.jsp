    ...
    <body>
            ...
            <tr height=100>
                ...
                <td>
                    <table height=100 cellspacing=0 cellpadding=0 width="100%" border=0>
                        ...
                        <tr>
                            <td style="font-weight: bold; font-size: 16px">${sessionScope.usertb.userName}</td>
						</tr>
                        <tr>
        ...
        <table cellspacing=0 cellpadding=2 width="95%" align=center border=0>
            <tr>
                ...
                <td style="color: #880000">${sessionScope.usertb.userName}</td></tr>
            <tr>
                <td align=right>真实姓名：</td>
                <td style="color: #880000">${sessionScope.usertb.userRealname}</td></tr>
            <tr>
                <td align=right>注册时间：</td>
                <td style="color: #880000">
                    <fmt:formatDate value="${sessionScope.usertb.regdate}" pattern="yyyy-MM-dd"></fmt:formatDate>
                </td></tr>
            <tr>
                <td align=right>登陆次数：</td>
                <td style="color: #880000">${sessionScope.usertb.logincount}</td></tr>
            <tr>
            ...
            <tr>
                ...
                <td style="color: #880000">
                    ...
                    <input type="button" name="subbut" value="查询"/>
                </td>
            </tr>
           <tr>
